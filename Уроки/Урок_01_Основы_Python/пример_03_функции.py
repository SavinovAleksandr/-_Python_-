...
print(f"Мощность при U=220В, I=5А: {мощность_1} Вт")
print(f"Мощность при U=230В, I=4.5А: {мощность_2} Вт")
...
print("\nРезультат 2 (переходный режим):", результат_2)
...
print("\n" + "=" * 50)
print("РЕКУРСИВНАЯ ФУНКЦИЯ (для понимания)")
print("=" * 50)
...
print(f"Факториал 5: {вычислить_факториал(5)}")
print(f"Факториал 7: {вычислить_факториал(7)}")
